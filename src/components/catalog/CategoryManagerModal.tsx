    ...
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 font-sans select-none">
      <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[85vh]" style={{ border: '1px solid #e2e8f0' }}>
        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <form onSubmit={handleCreateCategory} className="flex gap-2">
            <input
              ...
              className="flex-1 bg-slate-50 rounded-xl px-3.5 py-2 text-xs font-bold text-slate-900"
          ...
          {editingCategory && (
            <form onSubmit={handleUpdateCategory} className="p-3 bg-red-50/70 border border-red-200 rounded-xl space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-white rounded-lg px-3 py-1.5 text-xs font-extrabold text-slate-900"
                  style={{ outline: 'none', border: '1.5px solid #fca5a5' }}
                />
                <button
                  type="submit"
                  className="px-3 py-1.5 rounded-lg bg-red-600 text-white font-extrabold text-xs"
                  style={{ outline: 'none', border: 'none' }}
                >
                  Simpan
                </button>
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-slate-600 font-bold text-xs"
                  style={{ outline: 'none' }}
                >
                  Batal
                </button>
        ...
        <div className="p-4 border-t border-slate-100 bg-white flex justify-end">
          <button
            onClick={onClose}
            className="px-5 py-2.5 rounded-xl border border-slate-200 text-xs font-extrabold text-slate-700 hover:bg-slate-100 transition-colors"
            style={{ outline: 'none' }}
          >
            Selesai
          </button>
