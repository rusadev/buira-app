...
export const SplitBillModal: React.FC<SplitBillModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 font-sans select-none">
      <div className="bg-white rounded-none w-full max-w-md overflow-hidden flex flex-col max-h-[90vh] border border-slate-200 shadow-xl">
        ...
        <div className="p-4 border-b border-slate-100 bg-slate-50/60 flex items-center gap-2 shrink-0">
          <button
            ...
            className={`flex-1 py-2.5 px-3 rounded-none text-xs font-extrabold flex items-center justify-center gap-1.5 transition-all ${
              splitMode === 'equal'
        ...
        <div className="p-5 flex-1 overflow-y-auto min-h-0 space-y-4">
          ...
          {splitMode === 'equal' && (
            <div className="space-y-4">
              <div className="p-4 border border-slate-200 rounded-none bg-white space-y-2 text-center">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[2, 3, 4, 5].map(count => (
                    <button
                      ...
                      className={`py-3 rounded-none text-xs font-black transition-all border ${
                        personCount === count
              ...
              <div className="p-4 border border-emerald-200 rounded-none bg-emerald-50/50 space-y-1">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-none text-white font-black text-xs flex items-center justify-center gap-2"
          ...
          {splitMode === 'itemized' && (
            <div className="space-y-4">
              ...
              <div className="p-3.5 border border-slate-200 rounded-none bg-white space-y-1.5 text-xs font-bold">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-none text-white font-black text-xs flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
                style={{ outline: 'none', border: 'none', background: '#dc2626' }}
              >
                <CreditCard className="w-4 h-4" />
