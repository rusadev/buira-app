            ...
            <div className="p-4 border border-slate-200 rounded-none bg-white space-y-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-white rounded-none px-3 py-2 text-xs font-bold text-slate-900 border border-slate-200"
                  style={{ outline: 'none' }}
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3 rounded-none text-white font-black text-xs transition-all"
            ...
            <>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white rounded-none pl-9 pr-3 py-2 text-xs font-bold text-slate-900 border border-slate-200"
                  style={{ outline: 'none' }}
                />
              </div>
              ...
              <div className="space-y-2">
                {filteredMembers.map(mem => (
                  <div
                    ...
                    className="p-3.5 border border-slate-200 rounded-none bg-white hover:bg-slate-50 transition-all cursor-pointer flex items-center justify-between"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-none bg-white border border-slate-200 text-red-600 flex items-center justify-center font-black text-xs shrink-0">
                        {mem.name.charAt(0)}
                      </div>
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-extrabold text-slate-900">{mem.name}</span>
                          <span className={`px-2 py-0.2 rounded-none text-[9px] font-black uppercase ${
